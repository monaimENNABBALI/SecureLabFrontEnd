<template lang="">
    ...
    <main class="m-5">
        ...
        <strong class=" text-primary" >Conditions Générales d’Utilisation du site&nbsp;&nbsp;&nbsp;</strong>(lien du site)
        Les présentes Conditions Générales d’Utilisation (ci-après dénommées CGU) ont pour objet de définir
         ...
         (ci-après dénommé les Utilisateurs) du site ………… (lien du site) (ci-après dénommé le Site) 
