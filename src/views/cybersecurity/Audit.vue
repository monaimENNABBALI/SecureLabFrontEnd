                ...
                <div class="container">
                    <div id="first" class="container mt-6" style="height: 100vh;">
                        <div class="heading pt-4">
                            <h3 class="heading-title">Les audits de sécurité dans le cadre du RGPD</h3>
                            <p class="heading-cat">Dans le cadre de la mise en conformité RGPD d’une structure, il est nécessaire de déterminer les vulnérabilités potentielles en réalisant un audit de sécurité du SI.
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-3 col-sm-4">
                                <div class="icon-box icon-box-sm text-center p-5" style="background-color: #fff;">
                                    ...
                                    <div class="icon-box-content">
                                        <h3 class="icon-box-title" >Les textes de loi</h3><!-- End .icon-box-title -->
                            ...
                            <div class="col-lg-3 col-sm-4">
                                <div class="icon-box icon-box-sm text-center p-5" style="background-color: #fff;">
                                    ...
                                    <div class="icon-box-content">
                                        <h3 class="icon-box-title" >Les documents de référence dans le domaine de la sécurité informatique</h3><!-- End .icon-box-title -->
                                    </div><!-- End .icon-box-content -->
                                </div><!-- End .icon-box -->
                            </div><!-- End .col-lg-4 col-sm-6 -->
                            <div class="col-lg-3 col-sm-4">
                                <div class="icon-box icon-box-sm text-center p-5" style="background-color: #fff;">
                                    ...
                                    <div class="icon-box-content">
                                        <h3 class="icon-box-title" >La base documentaire du SI</h3><!-- End .icon-box-title -->
                                    </div><!-- End .icon-box-content -->
                                </div><!-- End .icon-box -->
                            </div><!-- End .col-lg-4 col-sm-6 -->
                            <div class="col-lg-3 col-sm-4">
                                <div class="icon-box icon-box-sm text-center p-5" style="background-color: #fff;">
                                    ...
                                    <div class="icon-box-content">
                                        <h3 class="icon-box-title" >La politique de sécurité du système d’information (PSSI)……</h3><!-- End .icon-box-title -->
                                    </div><!-- End .icon-box-content -->
                                </div><!-- End .icon-box -->
                            </div><!-- End .col-lg-4 col-sm-6 -->
                    ...
                    <div style="height:100vh;" class="py-5 my-5">
                        <h2 class="text-center heading-title my-5 ">La méthodologie de nos auditeurs</h2><!-- End .title -->
