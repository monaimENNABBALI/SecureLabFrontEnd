            ...
            <div class="activity-item">
                <div class="row">
                    ...
                    <div class="activity-listing-subtitle text-left">
                      <ul  style="padding-left: 15%;" class="mt-3">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6">
          <div class="activity-item">
              <div class="row">
                  ...
                  <div class="activity-listing-subtitle text-left"> <ul style="padding-left: 20%;" class="mt-3">
