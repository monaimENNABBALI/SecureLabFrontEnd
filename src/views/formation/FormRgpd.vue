<template lang="">
    <div class="background" style="min-height:81vh;background-image: url('/images/Formation/Formargpd.jpg');" >
      ...
      <div class="slider"  style="min-height:81vh;">
        ...
        <div class="mt-5">
          <img class="mx-auto rounded mb-3" src="/images/Programme.jpg" height="70" width="70" alt="">
        <ul class="mt-1">
      ...
      <div class="mt-5">
        <img class="mx-auto rounded my-5" src="/images/Pratique.jpg" height="70" width="70" alt="">
    ...
    <div class="mt-5">
    <img class="mx-auto rounded my-5" src="/images/plus.jpg" height="70" width="70" alt="">
  <ul class="mt-1">
  ...
  <li>-Formateurs certifiés PECB.</li>
    ...
    <!-- <div>
      <div class="d-inline "><img  height="150" width="150" src="/images/certifiante.jpg" alt=""><div>hello</div></div>
      <div class="d-inline "><img  height="90" width="90" src="/images/NonCertifiante.png" alt=""></div>
    </div> -->
        <div class="mt-5">
