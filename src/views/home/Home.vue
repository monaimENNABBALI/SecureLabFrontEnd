<template lang="">
    <Intro bgUrl="background-image: url('images/homeIntro.jpg');">
     ...
     <main id="main" style="background-color: #f5f5f5;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 offset-lg-1">
                            <div class="about-images">
                                <img src="images/cybersecurity-01.jpg" alt="" class="about-img-front">
            ...
            <div class="page-content  " style="margin-top: 50px; margin-left: 20%;">
                <div class="container">
                	<div class="row">
                		<div class="col-lg-9">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-5">
                                        <figure class="entry-media">
                                            <a href="single.html">
                                                <img src="images/cyber-security-article.jpg" alt="image desc">
                                            </a>
                            ...
                            <article class="entry entry-list">
                                <div class="row align-items-center">
                                    <div class="col-md-5">
                                        <figure class="entry-media">
                                            <a href="single.html">
                                                <img src="images/cybersecurity-03.jpg" alt="image desc">
                                            </a>
                                        </figure><!-- End .entry-media -->
                                    </div><!-- End .col-md-5 -->
